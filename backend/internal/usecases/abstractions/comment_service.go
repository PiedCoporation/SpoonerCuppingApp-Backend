...
type ICommentService interface {
	...
	GetDirectChildren(ctx context.Context, parentID uuid.UUID) ([]comment.CommentViewRes, error)
	GetRootCommentsByPostID(ctx context.Context, postID uuid.UUID) ([]comment.CommentViewRes, error)
